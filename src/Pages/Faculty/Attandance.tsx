    ...
    <div className='flex flex-col w-full m-10'>
      ...
      <table className="table-fixed text-left mb-5">
        <thead className='bg-sky-500/30'>
            <th className='pr-10 pl-3 pt-2 w-1/24'>No</th>
            <th className="pr-20 pl-3 w-2/12">Full Name</th>
            <th className="pr-20 pl-3 w-1/12">Gender</th>
            <th className="pr-20 pl-3 w-2/12">Subject</th>
            <th className="pr-20 pl-3 w-2/12">Attendance</th>
        ...
        <tbody>
          <tr className='bg-gray-100'>
            ...
            <td className='pl-3'>Computer Science</td>
          ...
          <tr className='bg-gray-200'>
            ...
            <td className='pl-3'>Cloud Computing</td>
